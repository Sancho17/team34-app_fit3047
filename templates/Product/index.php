...
<div class="product index content">
    ...
    <div class="shop-bottom-area">
        ...
        <div class="row" style="width: 80%;margin: 0 auto">
            ...
            <div class="col-lg-4  col-md-6 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-delay="200" style="padding: 30px">
                <!-- Single Prodect -->
                <div class="product mb-25px">
                    <div class="thumb">

                        <a href="product/detail?id=<?=$product->id?>" class="image">
                            <img src="webroot/assets/images/icons/detail/<?= h($product->image_link) ?>.png" alt="">
                            <img class="hover-image" src="webroot/assets/images/icons/detail/<?= h($product->image_link) ?>.png" alt="" />
                        ...
                        <button title="Quote" class=" add-to-cart"><a href="qoute/add?id=<?=$product->id?>">Quote</a></button>


                    </div>
                    <div class="content">
                        <h5 class="title"><a href="shop-left-sidebar.html"><?= h($product->name) ?></a></h5>
                        <span class="price">
                                            <span class="new">$<?= $this->Number->format($product->price) ?></span>
                                        </span>
                    </div>
                </div>
            </div>
