        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-left-image mb-md-30px mb-lm-30px" data-aos="fade-up">
                    <img src="../webroot/images/about-image/1.jpg" alt="" style="height:600px;" class="img-responsive w-100" />
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-content">
                    <div class="about-title" data-aos="fade-up">
                        <h2>Welcome To Biz Wizards</h2>
                    </div>
                    <p class="mb-30px" data-aos="fade-up" data-aos-delay="200">

                        COMBINING ELEGANCE AND ARTISTRY TO PERFECTION <br>
                        Biz Wizard defines timeless beauty, elegance and functionality, through a range of inspiring products and concepts for stone top installations.
                        Distinct in sheer sophistication and state-of-the-art design, we create kitchen and bathroom tops that are modern, functional and aesthetically
                        attractive. Transcending the ordinary in every sense, our products have the power to artistically transfer your most sublime thoughts to your living
                        space because at Biz Wizards, it’s all about you, for we create what you dream.
                        <br>
                        <br>

                        OPEN YOUR EYES TO DESIGN DEMOCRACY <br>
                        At Present, Biz Wizard has proved to be the standards in manufacturing aesthetic stone top masterpieces that are inspired by nature.
                        Continuous innovation and a quest for going beyond the ordinary has been the brand’s recipe for success in creating flawless masterpieces
                        that provide aesthetic and functional value to all the customers of Biz Wizards.

                        <br>
                        <br>

                        ELEGANCE RECOGNIZED <br>
                        While our greatest reward remains the happiness and satisfaction of our thousands of established customers,
                        our commitment to constant evolution and greater levels of excellence has been recognized and awarded locally as we
                        received the prestigious honor of being ranked in the Australian Business Leaders ‘Best Return on Investment’ in 2020.
